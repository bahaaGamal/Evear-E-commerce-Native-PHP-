                ...
                <div class="row">
                    <div class="col-12">
                            ...
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="action" data-title="Remove"><a href="app/remove_from_card.php?id=<?= $product['id'] ?>" class="text-muted"><i class="fi-rs-trash"></i></a></td>
                                    </tr>
                                    <?php endforeach; ?>
                        ...
                        <div class="cart-action text-end">
                            <a href="index.php" class="btn "><i class="fi-rs-shopping-bag mr-10"></i>Continue Shopping</a>
                        </div>

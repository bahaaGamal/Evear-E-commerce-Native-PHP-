                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            <ul>
                                ...
                                <li><i class="fi-rs-user"></i><a href="login.php">Log In</a></li>
                                <li><i class="fi-rs-user"></i><a href="sign-up.php">Sign Up</a></li>
                                <?php endif; ?>
                                <?php if(isset($_SESSION["auth"])): ?>
                                <li><i class="fi-rs-user"></i><a href="logout.php">Log Out</a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    </div>
